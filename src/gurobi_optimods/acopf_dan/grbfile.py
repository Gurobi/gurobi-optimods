...
def read_configfile(alldata, filename):
    ...
    for x in [('casefilename', casefilename), ('lpfilename', lpfilename),
              ...
              ('skipjabr', skipjabr), ('useactivelossineqs', useactivelossineqs), ('usemipstart', usemipstart), ('cutplane', cutplane), ('dodc',dodc), ('doiv',doiv), ('ivtype',ivtype),
              ...
              ('usemaxphasediff', usemaxphasediff), ('maxphasediff_deg', maxphasediff_deg),              
