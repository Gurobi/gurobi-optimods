...
Usage examples:
    ...
    from gurobi_optimods.datasets import load_opf_example, load_filepath
    ...
    coordinates = opf.read_coords_csv(load_filepath("case9coords.csv"))
    ...
    voltages = opf.read_coords_csv(load_filepath("case9volts.csv"))
...
from gurobi_optimods.opf.io import read_coords_csv  # noqa: F401
from gurobi_optimods.opf.io import read_voltages_csv  # noqa: F401
